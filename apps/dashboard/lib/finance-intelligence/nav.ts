...
export const FINANCE_NAV_SECTIONS: FinanceNavSection[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'team-payments', label: 'Team Payments', href: '/finance/approvals/team-payments' },
...
export const FINANCE_PAGES: FinancePageMeta[] = [
  ...
  // Payment Management — full request types
  page('/finance/approvals', 'Approval Dashboard', 'Summary of payment approval activity. Action pending items in My Approval Inbox.', 'approvals', 'approvals-dashboard', ['Payment Management', 'Approval Dashboard']),
  page('/finance/approvals/inbox', 'My Approval Inbox', 'Requests awaiting your decision.', 'approvals', 'payment-requests', ['Payment Management', 'My Approval Inbox']),
  page('/finance/approvals/payments', 'Payment Requests', 'Approved and in-progress payments. Create requests and filter by payment type.', 'approvals', 'payment-requests', ['Payment Management', 'Payment Requests']),
  page('/finance/approvals/my-requests', 'My Requests', 'Drafts, pending, returned, approved, awaiting retirement and completed requests you own.', 'approvals', 'payment-requests', ['Payment Management', 'My Requests']),
  page('/finance/approvals/team-payments', 'Team Payments', 'View payment status for employees who report to you. View only — you cannot pay or process these requests here.', 'approvals', 'payment-requests', ['Payment Management', 'Team Payments']),
  page('/finance/approvals/treasury', 'Treasury Operations', 'Ready for payment, paid today, retirement verification and payment history.', 'approvals', 'treasury-ops', ['Payment Management', 'Treasury Operations']),
  page('/finance/approvals/sage-posting', 'Finance Posting Desk', 'Paid and retired payments awaiting finance acknowledgement as posted. Marked posted items leave this worklist.', 'approvals', 'finance-posting', ['Payment Management', 'Finance Posting Desk']),
  page('/finance/approvals/supplier-payments', 'Supplier Payments', 'Redirects to Payment Requests filtered to supplier invoices.', 'approvals', 'payment-requests', ['Payment Management', 'Supplier Payments']),
  page('/finance/approvals/expense-payments', 'Expense Payments', 'Redirects to Payment Requests filtered to expense payments.', 'approvals', 'payment-requests', ['Payment Management', 'Expense Payments']),
  page('/finance/approvals/batches', 'Payment Batches', 'Batch payment approval and release monitoring.', 'approvals', 'approval-queue', ['Payment Management', 'Payment Batches']),
  page('/finance/approvals/cash-advances', 'Cash Advances', 'Redirects to Payment Requests filtered to cash advances.', 'approvals', 'payment-requests', ['Payment Management', 'Cash Advances']),
  page('/finance/approvals/advance-retirement', 'Cash Advance Controls', 'CFO controls for outstanding cash advances: cancel retirement requirement or grant a one-time waiver.', 'approvals', 'cash-advance-controls', ['Payment Management', 'Cash Advance Controls']),
  page('/finance/approvals/expense-claims', 'Expense Claims', 'Employee expense claim approvals.', 'approvals', 'approval-queue', ['Payment Management', 'Expense Claims']),
  page('/finance/approvals/budget-requests', 'Budget Requests', 'Budget request approvals.', 'approvals', 'approval-queue', ['Payment Management', 'Budget Requests']),
  page('/finance/approvals/budget-transfers', 'Budget Transfers', 'Budget transfer approvals.', 'approvals', 'approval-queue', ['Payment Management', 'Budget Transfers']),
  page('/finance/approvals/fx-requests', 'Foreign Exchange Requests', 'FX purchase and conversion requests.', 'approvals', 'approval-queue', ['Payment Management', 'Foreign Exchange Requests']),
  page('/finance/approvals/tax-payments', 'Tax Payments', 'Tax payment approval requests.', 'approvals', 'approval-queue', ['Payment Management', 'Tax Payments']),
  page('/finance/approvals/write-offs', 'Write-Off Requests', 'Write-off approval requests.', 'approvals', 'approval-queue', ['Payment Management', 'Write-Off Requests']),
  page('/finance/approvals/asset-disposal', 'Asset Disposal Requests', 'Asset disposal approval requests.', 'approvals', 'approval-queue', ['Payment Management', 'Asset Disposal Requests']),
  page('/finance/approvals/project-variations', 'Project Variation Requests', 'Project variation / change-order financial approvals.', 'approvals', 'approval-queue', ['Payment Management', 'Project Variation Requests']),
  page('/finance/approvals/report-signoff', 'Report Sign-Off Requests', 'Financial report sign-off requests.', 'approvals', 'approval-queue', ['Payment Management', 'Report Sign-Off Requests']),
  page('/finance/approvals/other', 'Other Finance Requests', 'Cash advances, expenses, budget, FX, tax, write-offs and related requests.', 'approvals', 'section-dashboard', ['Payment Management', 'Other Finance Requests'], [
  ...
  page('/finance/approvals/request/[requestId]', 'Approval Detail', 'Payment approval detail with financial context, evidence and workflow actions.', 'approvals', 'approval-detail', ['Payment Management', 'Approval Detail']),
