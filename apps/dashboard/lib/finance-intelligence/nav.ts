...
export const FINANCE_PAGES: FinancePageMeta[] = [
  ...
  page('/finance/approvals', 'Approval Dashboard', 'Summary of payment approval activity. Action pending items in My Approval Inbox.', 'approvals', 'approvals-dashboard', ['Payment Approvals', 'Approval Dashboard']),
  page('/finance/approvals/inbox', 'My Approval Inbox', 'Requests awaiting your decision.', 'approvals', 'payment-requests', ['Payment Approvals', 'My Approval Inbox']),
  page('/finance/approvals/payments', 'Payment Requests', 'Approved and in-progress payments. Create requests and filter by payment type.', 'approvals', 'payment-requests', ['Payment Approvals', 'Payment Requests']),
  ...
  page('/finance/approvals/supplier-payments', 'Supplier Payments', 'Redirects to Payment Requests filtered to supplier invoices.', 'approvals', 'payment-requests', ['Payment Approvals', 'Supplier Payments']),
  page('/finance/approvals/expense-payments', 'Expense Payments', 'Redirects to Payment Requests filtered to expense payments.', 'approvals', 'payment-requests', ['Payment Approvals', 'Expense Payments']),
  ...
  page('/finance/approvals/cash-advances', 'Cash Advances', 'Redirects to Payment Requests filtered to cash advances.', 'approvals', 'payment-requests', ['Payment Approvals', 'Cash Advances']),
