...
const sections: TimePayload['sections'] = [
  ...
  { id: 'timesheet-recapture', label: 'Timesheet Recapture', description: 'Find omitted or incomplete days and reopen timesheets for correction before payroll is submitted for approval.', actions: ['find-gaps', 'reopen', 'open-entry'], controls: ['Payroll submit gate', 'Audit reopen reason', 'Period open required'], reports: ['Missing Days', 'Incomplete Capture', 'Recapture Audit'] },
];
