...
const sections: TimePayload['sections'] = [
  ...
  { id: 'timesheet-recapture', label: 'Timesheet Recapture', description: 'Find omitted or incomplete days and reopen timesheets for correction before payroll is submitted for approval.', actions: ['reopen', 'edit', 'synchronize-attendance', 'view-history'], controls: ['Payroll submit gate', 'Audit reopen reason', 'Period open required'], reports: ['Missing Days', 'Incomplete Capture', 'Recapture Audit'] },
  { id: 'dayrate-schedule-reconcile', label: 'Dayrate Payment Schedule', description: 'Upload the official DLE/DLPC Dayrate Payment Schedule Excel and apply it as the payroll overlay for daily-rate C-codes for the selected period.', actions: ['import', 'validate', 'post-to-payroll', 'reopen'], controls: ['Excel is source of truth', 'Period overlay only', 'Day timesheets unchanged'], reports: ['Excel vs Timesheet Days', 'Dropped C-codes', 'Payable Overlay'] },
];
