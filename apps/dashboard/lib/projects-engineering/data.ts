...
/** Seed portfolio — managerEmployeeCode should be linked to real employee codes when assigning PMs. */
export const projects: Project[] = [
  {
    id: 'hdjk',
    code: 'HDJK-001',
    name: 'HD/JK Integrated EPC Development',
    client: 'Major Energy Client',
    manager: 'Engr. A. Adeyemi',
    managerEmployeeCode: '',
    contractValue: 18600000000,
    currency: 'NGN',
    start: '2026-02-03',
    finish: '2027-06-30',
    planned: 42.8,
    actual: 39.6,
    costPerformance: 0.97,
    schedulePerformance: 0.93,
    phase: 'Engineering / Procurement',
    status: 'Active',
    health: 'Watch',
    location: 'Lagos / Project Sites',
    businessUnit: 'Projects & Engineering',
    description: 'Integrated engineering, procurement, fabrication, construction support and information handover programme.',
    projectType: 'EPC',
  },
  {
    id: 'delta',
    code: 'DLE-ENG-026',
    name: 'Delta Fabrication Upgrade',
    client: 'Industrial Client',
    manager: 'Engr. M. Okafor',
    managerEmployeeCode: '',
    contractValue: 4250000000,
    currency: 'NGN',
    start: '2026-01-12',
    finish: '2026-12-18',
    planned: 61.4,
    ...
    schedulePerformance: 1.03,
    phase: 'Fabrication',
    status: 'Active',
    health: 'Healthy',
    location: 'Lagos Fabrication Yard',
    businessUnit: 'Operations',
    description: 'Brownfield engineering and fabrication upgrade programme.',
    projectType: 'FABRICATION',
  },
  {
    id: 'pipeline',
    code: 'PIPE-014',
    name: 'Pipeline Integrity Rehabilitation',
    client: 'Energy Infrastructure Client',
    manager: 'Engr. T. Eze',
    managerEmployeeCode: '',
    contractValue: 7900000000,
    currency: 'NGN',
    start: '2026-03-08',
    finish: '2027-02-15',
    planned: 31.5,
    actual: 25.1,
    costPerformance: 0.91,
    ...
    businessUnit: 'Projects & Engineering',
    description: 'Integrity engineering, procurement and rehabilitation works.',
    projectType: 'ENGINEERING',
  },
  {
    id: 'terminal',
    code: 'TERM-011',
    name: 'Terminal Electrical Reliability Works',
    client: 'Marine Terminal Client',
    manager: 'Engr. I. Bello',
    managerEmployeeCode: '',
    ...
    actual: 80.7,
    costPerformance: 1.0,
    schedulePerformance: 0.98,
    phase: 'Construction',
    status: 'Active',
    health: 'Healthy',
    location: 'Lagos',
    businessUnit: 'Projects & Engineering',
    description: 'Electrical and instrumentation reliability enhancement works.',
...
export const portfolioKpis = [
  ...
  { label: 'Portfolio Value', value: '₦48.7bn', delta: '₦31.8bn committed', tone: 'indigo' },
  { label: 'Overall Progress', value: '46.8%', delta: '49.2% planned', tone: 'cyan' },
  { label: 'Projects At Risk', value: '3', delta: '1 critical · 2 watch', tone: 'amber' },
...
export const milestones = [
  ...
  ['M-051', 'Client Progress Review', 'Management', '28 Sep 2026', '—', 'Healthy'],
];

export const engineeringDeliverables = [
  ['ENG-PIP-0112', 'Piping General Arrangement – Unit 300', 'Piping', 'Rev C', 'IFC', '12 Sep 2026', 'Engr. O. James', 'Watch'],
  ['ENG-STR-0087', 'Pipe Rack Structural Details', 'Civil/Structural', 'Rev B', 'Client Review', '09 Sep 2026', 'Engr. F. Musa', 'Critical'],
  ['ENG-ELE-0051', 'Single Line Diagram – MCC-04', 'Electrical', 'Rev A', 'Approved', '04 Sep 2026', 'Engr. K. Udo', 'Healthy'],
  ['ENG-INS-0072', 'Instrument Index', 'Instrumentation', 'Rev D', 'Checker Review', '13 Sep 2026', 'Engr. S. Obi', 'Watch'],
  ['ENG-PRO-0035', 'Process Datasheet – Separator V-204', 'Process', 'Rev B', 'Approved', '02 Sep 2026', 'Engr. N. Cole', 'Healthy'],
];

export const procurement = [
  ['PR-026-104', 'Structural Steel Package', 'Approved PO', 'Vendor A', '₦1.28bn', '23 Sep 2026', '68%', 'Critical'],
  ['PR-026-119', 'Control Valves', 'Technical Evaluation', 'Vendor TBD', '₦420m', '08 Oct 2026', '41%', 'Watch'],
  ['PR-026-097', 'Electrical Cables', 'Manufacturing', 'Vendor B', '₦615m', '26 Sep 2026', '76%', 'Healthy'],
  ['PR-026-128', 'Pipe Fittings', 'RFQ', 'Bid Stage', '₦198m', '17 Oct 2026', '22%', 'Watch'],
];
