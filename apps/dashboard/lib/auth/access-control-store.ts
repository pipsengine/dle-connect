...
export const permissionCatalog: PermissionNode[] = [
  ...
  node('Human Resources', 'Performance', 'Performance Management', 'Performance Module', 'Module', 'L2 - HR Admin', 'Company', 'performance'),
  node('Human Resources', 'Performance', 'Cycle Management', 'Performance Cycles', 'Workflow', 'L2 - HR Admin', 'Company', 'performance.cycles'),
  node('Human Resources', 'Performance', 'Company Objectives', 'Strategic Objectives', 'Module', 'L2 - HR Admin', 'Company', 'performance.objectives'),
  node('Human Resources', 'Performance', 'OKR & KPI', 'Employee Goals', 'Workflow', 'L1 - User', 'Own', 'performance.goals'),
  node('Human Resources', 'Performance', 'Reviews', 'Assessments & Results', 'Workflow', 'L2 - Manager', 'Team', 'performance.reviews'),
  node('Human Resources', 'Performance', 'Calibration', 'Calibration Governance', 'Workflow', 'L2 - HR Admin', 'Company', 'performance.calibration'),
  node('Human Resources', 'Performance', 'Appeals', 'Appeals Workflow', 'Workflow', 'L2 - HR Admin', 'Company', 'performance.appeals'),
  node('Human Resources', 'Performance', 'Probation', 'Probation & Confirmation', 'Workflow', 'L2 - Manager', 'Team', 'performance.probation'),
  node('Human Resources', 'Performance', 'Administration', 'Performance Configuration', 'System', 'L3 - Super Admin', 'Company', 'performance.admin'),
  node('Page Access', 'HRIS', 'Performance Management', 'Performance Workspace Page', 'Page', 'L2 - HR Admin', 'Company', 'page.hris.performance-management'),
  ...
  node('Page Access', 'Payroll', 'Bank & Finance', 'Bank & Finance Workspace', 'Page', 'L3 - Finance Approver', 'Company', 'page.payroll.management.bank-finance'),
  node('Page Access', 'Payroll', 'Payroll Approval Workspace', 'Payroll Approval Center', 'Page', 'L3 - Payroll Approver', 'Company', 'page.payroll.management.approval'),
  ...
  node('Human Resources', 'Timesheet', 'Time & Logs', 'Timesheet Workflow (supervisors, line managers, IT, admins — not employees)', 'Workflow', 'L2 - Supervisor', 'Team', 'timesheet'),
  ...
  node('Page Access', 'Recruitment', 'Recruitment Module', 'Recruitment Management Pages', 'Page', 'L2 - HR Admin', 'Department', 'page.hris.recruitment'),
  node('Page Access', 'Recruitment', 'Recruitment Dashboard', 'Recruitment Dashboard Page', 'Page', 'L2 - HR Admin', 'Department', 'page.hris.recruitment.dashboard'),
  node('Page Access', 'Recruitment', 'Manpower Request', 'Manpower Request Page', 'Page', 'L2 - HR Admin', 'Department', 'page.hris.recruitment.manpower-request'),
  node('Human Resources', 'Onboarding', 'Onboarding', 'Employee Onboarding', 'Workflow', 'L2 - HR Admin', 'Department', 'onboarding'),
  node('Human Resources', 'Offboarding', 'Offboarding Management', 'Exit workflow (HR only — resignation through final payroll)', 'Workflow', 'L2 - HR Admin', 'Department', 'offboarding'),
  node('Human Resources', 'Offboarding', 'Exit Clearance Approval', 'Department clearance section approve/reject (line managers)', 'Workflow', 'L2 - Manager', 'Team', 'offboarding.clearance'),
  node('Page Access', 'Offboarding', 'Resignation Management', 'Resignation Register Page', 'Page', 'L2 - HR Admin', 'Department', 'page.hris.offboarding.resignation-management'),
  node('Page Access', 'Offboarding', 'Handover Checklist', 'Handover Checklist Page', 'Page', 'L2 - HR Admin', 'Department', 'page.hris.offboarding.handover-checklist'),
  node('Page Access', 'Offboarding', 'Exit Clearance', 'Exit Clearance Form & Approvals Page', 'Page', 'L2 - Manager', 'Team', 'page.hris.offboarding.exit-clearance'),
  node('Page Access', 'Offboarding', 'Asset Return', 'Asset Return Page', 'Page', 'L2 - HR Admin', 'Department', 'page.hris.offboarding.asset-return'),
  node('Page Access', 'Offboarding', 'Final Payroll Processing', 'Final Payroll Settlement Page', 'Page', 'L2 - HR Admin', 'Department', 'page.hris.offboarding.final-payroll'),
...
permissionCatalog.push(
  ...
  node('Page Access', 'Time & Logs', 'Crew Mobilization', 'Crew Mobilization Page', 'Page', 'L2 - HR Admin', 'Company', 'page.hris.time-and-logs.crew-mobilization'),
  ...
  node('Leave', 'Approval', 'Line Manager Leave Approval', 'Supervisor / Line Manager Leave Review', 'Workflow', 'L2 - Manager', 'Team', 'leave.workflow.line-manager'),
  node('Leave', 'Approval', 'HR Leave Approval', 'HR Manager Leave Review', 'Workflow', 'L2 - HR Admin', 'Company', 'leave.workflow.hr'),
...
const defaultTemplates = (): PermissionTemplate[] => {
  ...
  return [
    ...
    {
      id: 'tpl-recruitment-hr',
      name: 'Recruitment Management (HR)',
      description: 'Full Recruitment Management for HR and Recruitment Officers: manpower, requisitions, candidates, offers, and approvals. Not for ordinary employees.',
      permissions: [
        ...pick('recruitment', 'page.hris.recruitment'),
        'employees.view',
        'onboarding.submit',
        'hris.view',
      ],
    ...
    },
    {
      ...
      dataScope: 'Company',
      approvalLevel: 'L3 - Finance Approver',
    },
    {
