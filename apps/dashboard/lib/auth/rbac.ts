...
export const roleDefinitions: RoleDefinition[] = [
  ...
  role('Finance Administrator', 'Finance', ['finance.*', 'view_finance_intelligence', 'view_finance_accounting', ...financeBankFinancePerms, ...payrollFinanceReviewPerms], 'Finance Intelligence administration with payroll salary review.'),
  role('Finance Manager', 'Finance', [...financeBankFinancePerms, ...payrollFinanceReviewPerms, 'finance.view', 'finance.approve', 'view_finance_intelligence', 'reports.view'], 'Finance Intelligence management with payroll approval and salary review access.'),
  role('Finance Controller', 'Finance', [...financeBankFinancePerms, ...payrollFinanceReviewPerms, 'finance.view', 'finance.approve', 'view_finance_intelligence', 'reports.view'], 'Finance controller payroll approval and salary review.'),
