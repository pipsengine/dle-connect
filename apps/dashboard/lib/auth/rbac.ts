...
export const roleDefinitions: RoleDefinition[] = [
  ...
  role('HR Administrator', 'HRIS', ['hris.*', 'employees.*', 'leave.*', 'workflow.*', 'offboarding.*', 'payroll.view', 'performance.admin', ...performanceHrPerms, ...payrollHrReviewPerms, ...telephoneAllowanceHrReviewPerms, ...telephoneAllowanceHrApprovePerms], 'Full HRIS administration including payroll salary review.'),
