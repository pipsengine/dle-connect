...
export const performanceMenuTree: PerformanceMenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'corporate-goals', label: 'Corporate Goals', route: 'planning/corporate-goals', icon: Target, roles: ['HR Manager', 'Executive Management', 'Super Administrator'], keywords: ['strategic', 'company'] },
      { id: 'department-goals', label: 'Department Goals', route: 'planning/department-goals', icon: Target, roles: MANAGEMENT, keywords: ['team goals', 'dept'] },
      { id: 'employee-goals', label: 'Employee Goals', route: 'planning/employee-goals', icon: Target, roles: EMPLOYEE, keywords: ['goals', 'objectives', 'targets'] },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'supervisor-review', label: 'Supervisor Review', route: 'performance-reviews/supervisor-review', icon: Users, roles: ['Supervisor', 'Project Manager', ...ALL_HR], badgeKey: 'supervisor-review', keywords: ['supervisor', 'manager review'] },
      { id: 'project-manager-review', label: 'Project Manager Review', route: 'performance-reviews/project-manager-review', icon: Briefcase, roles: ['Project Manager', ...ALL_HR], badgeKey: 'project-manager-review', keywords: ['project', 'pm review'] },
      { id: '360-review', label: '360° Review', route: 'performance-reviews/360-review', icon: RotateCw, roles: [...MANAGEMENT, ...ALL_HR], keywords: ['360', 'feedback'] },
      { id: 'final-evaluation', label: 'Final Evaluation', route: 'performance-reviews/final-evaluation', icon: BadgeCheck, roles: ALL_HR, keywords: ['final', 'evaluation'] },
      { id: 'performance-scorecard', label: 'Performance Scorecard', route: 'performance-reviews/performance-scorecard', icon: BarChart3, roles: [...MANAGEMENT, ...ALL_HR], keywords: ['scorecard', 'score'] },
    ],
  },
  {
