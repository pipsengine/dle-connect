  ...
  return (
    <>
      ...
      <Card
        ...
        subtitle="Connector health overview — manage endpoints and sync from Integrations"
        action={
      ...
      >
        <DataTable
          ...
          rows={[
            ...
            ['MS Project / Procore / Aconex', 'Optional schedule & field / CDE tools', 'API', '—', 'PMO / Construction', <Status key="opt">Not configured</Status>],
          ]}
        />
      </Card>
    </>
