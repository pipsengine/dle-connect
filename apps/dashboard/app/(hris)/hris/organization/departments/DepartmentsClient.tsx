                ...
                <button type="button" onClick={() => onSelect(department.id)} className="w-full text-left">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <div className="mt-1 truncate text-xs text-slate-500">Head of Department: {department.leader}</div>
                    </div>
        ...
        {loading ? (
          ...
          <table className="w-full min-w-[960px] text-left">
            <thead className="bg-slate-50">
              <tr>
                {['Department', 'Code', 'Head of Department', 'Location', 'Health', 'Headcount', 'Teams', 'Actions'].map((header) => (
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-xl border border-[#E5E7EB] bg-white p-5 shadow-sm">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3 md:grid-cols-4">
          <DetailStat label="Head of Department" value={selectedDepartment.leader} />
...
function DepartmentHeadPicker({
  ...
  return (
    <div className="space-y-1" ref={rootRef}>
      <span className="text-xs font-semibold text-slate-600">Head of Department</span>
      <div className="relative">
        ...
        {query ? (
          <button
            ...
            aria-label="Clear head of department"
          >
