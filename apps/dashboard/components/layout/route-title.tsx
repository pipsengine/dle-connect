...
const titleOverrides: Record<string, string> = {
  ...
  '/hris/payroll-management/process-payroll': 'Process Payroll',
  '/hris/payroll-management/process-payroll/dle-salaries': 'DLE Salaries',
  '/hris/payroll-management/process-payroll/dle-usd': 'DLE USD',
  '/hris/payroll-management/process-payroll/dlpc-salaries': 'DLPC Salaries',
  '/hris/payroll-management/process-payroll/dle-dayrate': 'DLE Day-rate',
  '/hris/payroll-management/process-payroll/dlpc-dayrate': 'DLPC Day-rate',
  '/hris/payroll-management/payroll-approval': 'Payroll Approval',
  '/hris/payroll-management/payroll-approval/dle-salaries': 'DLE Salaries Approval',
  '/hris/payroll-management/payroll-approval/dle-usd': 'DLE USD Approval',
  '/hris/payroll-management/payroll-approval/dlpc-salaries': 'DLPC Salaries Approval',
  '/hris/payroll-management/payroll-approval/dle-dayrate': 'DLE Day-rate Approval',
  '/hris/payroll-management/payroll-approval/dlpc-dayrate': 'DLPC Day-rate Approval',
  '/hris/payroll/payroll-workflow': 'Payroll Workflow',
  '/hris/payroll/payroll-approval': 'Payroll Approval',
  ...
  '/hris/offboarding/resignation-management': 'Resignation Management',
  '/hris/offboarding/resignation-management/new': 'New Resignation',
  '/hris/offboarding/handover-checklist': 'Handover Checklist',
  '/hris/offboarding/exit-clearance': 'Exit Clearance',
  '/hris/offboarding/asset-return': 'Asset Return',
  '/hris/offboarding/final-payroll-processing': 'Final Payroll Processing',
  '/hris/offboarding/final-payroll-processing/new-settlement': 'New Final Payroll Settlement',
